...
<html>
<head>
	<title>Cetak Produk Masuk</title>
	...
	<table class="table table-bordered table-hover table-striped table-sm">
		...
		<tbody>
			...
			if(isset($_POST['submit'])){
				$tgl_a = $_POST['tgl_a'];
				$tgl_b = $_POST['tgl_b'];
				$produk = mysqli_query($koneksi,"SELECT * FROM produkmasuk WHERE tgl BETWEEN '$tgl_a' AND '$tgl_b'");
			}else{
				$produk = mysqli_query($koneksi, "SELECT * FROM produkmasuk");
			}
